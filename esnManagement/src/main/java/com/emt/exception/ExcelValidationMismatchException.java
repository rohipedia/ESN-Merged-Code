...
public class ExcelValidationMismatchException extends RuntimeException {
		...
		public ExcelValidationMismatchException(String message, Throwable cause) {
			super(message, cause);
		}

		public ExcelValidationMismatchException(String message) {
			super(message);
		}

		public ExcelValidationMismatchException(Throwable cause) {
			super(cause);
		}
