...
public class ApiValidationFailureException extends RuntimeException {
		...
		public ApiValidationFailureException(String message, Throwable cause) {
			super(message, cause);
		}

		public ApiValidationFailureException(String message) {
			super(message);
		}

		public ApiValidationFailureException(Throwable cause) {
			super(cause);
		}
