...
/**
 * <p>Java class for StoreErrorInfo complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="StoreErrorInfo"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "StoreErrorInfo", propOrder = {
    "storeErrorCode",
    "storeErrorDescription"
})
public class StoreErrorInfo {

    @XmlElement(name = "StoreErrorCode", required = true, nillable = true)
    protected String storeErrorCode;
    @XmlElement(name = "StoreErrorDescription", required = true, nillable = true)
