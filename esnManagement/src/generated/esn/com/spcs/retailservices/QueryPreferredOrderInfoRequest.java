...
/**
 * <p>Java class for QueryPreferredOrderInfoRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="QueryPreferredOrderInfoRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "QueryPreferredOrderInfoRequest", propOrder = {
    "ban",
    "esn",
    "mdn"
})
public class QueryPreferredOrderInfoRequest
    extends Request
{

    @XmlElement(required = true)
    protected String ban;
    @XmlElementRef(name = "esn", namespace = "java:com.spcs.retailservices.domain", type = JAXBElement.class, required = false)
    protected JAXBElement<String> esn;
    @XmlElementRef(name = "mdn", namespace = "java:com.spcs.retailservices.domain", type = JAXBElement.class, required = false)
